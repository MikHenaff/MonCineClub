    ...
    <?php elseif(Authenticator::isLogged()): ?>
        <form action="./update-profile" method="POST">
            ...
            <div class="register">
                ...
                <input class="input-register" type="text" name="updated_username" id="updated_username">
            </div>
            <div class="register">
            ...
            <div class="register">
                ...
                <input class="input-register" type="email" name="updated_email" id="updated_email"> 
            </div>
            <a class="btn-cancel-register" href="./home">Annuler</a>
            <button class="btn-register" type="submit">Modifier</button>
